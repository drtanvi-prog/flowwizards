...
const PIPEDRIVE_QUOTES = [
  {
    text: "I've worked with Flow Digital on creating automations between Pipedrive and Asana. It has saved me and my team countless hours of manual work. The ROI was clear from day one — worth the investment many times over!",
    author: "L. M., Rethink and Execute",
    bg: "#eef5e0",
    border: "#b5c86a",
    quoteColor: "#7a8c00",
  },
  {
    text: "We used to send our leads a PDF via email manually, which they downloaded, printed, signed, scanned, and emailed back to us. This entire process is now fully automated and integrated with our CRM. Sales have increased threefold!",
    author: "B. W., Auto Sales",
    bg: "#f0faf5",
    border: "#86efac",
    quoteColor: "#16a34a",
  },
  {
    text: "Nathan and his team are Pipedrive and automation wizards! They helped us immensely in figuring out our sales processes and how to best use Pipedrive to manage our pipeline. Highly recommend Flow Digital to anyone serious about growing their sales.",
    author: "Andy Altman, Director of Marketing, iTRAVEL",
    bg: "#fff8f0",
    border: "#f5d5b0",
    quoteColor: "#f07020",
  },

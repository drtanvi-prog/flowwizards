      ...
      <div className="relative max-w-7xl mx-auto px-6 xl:px-16">
        ...
        <div className="mb-16 sm:mb-20">
          ...
          <motion.h2
            ...
            className="text-[1.3rem] sm:text-[2.75rem] lg:text-[3.25rem] xl:text-[3.5rem] font-extrabold leading-tight sm:leading-[1.12] text-center"
              ...
              {reasons.map((r, index) => {
                ...
                return (
                  <motion.button
                    ...
                    className="relative flex items-center gap-3 px-3 py-3.5 rounded-md text-left shrink-0 lg:w-full cursor-pointer"
                    style={{
              ...
              <div className="grid grid-cols-1 md:grid-cols-[1.05fr_1fr]">
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      background: `radial-gradient(circle, ${active.color}20, transparent 65%)`,
                    }}
                  />

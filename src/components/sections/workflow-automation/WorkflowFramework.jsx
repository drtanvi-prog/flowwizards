...
import ShapeEl from '../ai-automation-framework/ShapeEl';
...
const WorkflowFramework = ({
   ...
   heading = 'Workflow automation follows a system.',
   description = 'Without a system, automations become difficult to manage and hard to scale. We use a proven, structured delivery process to move from clarity to execution, keeping outcomes and accountability front and center.',
   hideHeading = false,
   ...
   return (
      <>
         <WorkflowMobileLayout steps={steps} chip={chip} heading={heading} description={description} />
         <section
            ref={ref}
            ...
            <div className="sticky top-20 xl:top-25 h-[calc(100vh-5rem)] xl:h-[calc(100vh-6.25rem)] overflow-hidden flex flex-col">
               <div className="px-6 sm:px-10 xl:px-16 pt-5 sm:pt-6 pb-2 sm:pb-3 shrink-0">
                  <div className="max-w-7xl mx-auto">
                     ...
                     >
                        <Chip className="border border-[#ff4f00]">{chip}</Chip>
                     </motion.div>
                     {!hideHeading && (
                        <motion.h2
...
export default WorkflowFramework;
